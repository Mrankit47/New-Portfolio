...
const Footer = () => {
    return (
        <footer className="py-8 sm:py-12 px-4 sm:px-6 md:px-24 border-t border-white/5 flex flex-col md:flex-row justify-between items-center space-y-6 sm:space-y-8 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-white/30">
                {/* Email */}
                <a href="https://mail.google.com/mail/?view=cm&to=ankitkushwah0210k@gmail.com" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-all duration-300 transform hover:-translate-y-1">
